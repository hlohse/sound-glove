...
#define BTPS_CONFIGURATION_TIMER_MINIMUM_TIMER_RESOLUTION_MS                 50
   ...
   /*          received.                                                */
#define BTPS_CONFIGURATION_HCI_DRIVER_RECEIVE_PACKET_BUFFER_SIZE           (HCI_CALCULATE_ACL_DATA_SIZE(339))
...
#define BTPS_CONFIGURATION_HCI_NUMBER_OF_SCO_DATA_PACKETS                  0
   ...
   /* L2CAP Configuration.                                              */
#define BTPS_CONFIGURATION_L2CAP_MAXIMUM_SUPPORTED_STACK_MTU               (339 - L2CAP_DATA_PACKET_HEADER_SIZE)
...
#define BTPS_CONFIGURATION_SPP_DEFAULT_TRANSMIT_BUFFER_SIZE               (58*1)
#define BTPS_CONFIGURATION_SPP_DEFAULT_RECEIVE_BUFFER_SIZE                (58*1)
#define BTPS_CONFIGURATION_SPP_DEFAULT_FRAME_SIZE                         ((58 > SPP_FRAME_SIZE_MAXIMUM)?SPP_FRAME_SIZE_MAXIMUM:58)
...
#define BTPS_CONFIGURATION_AVRCP_SUPPORT_VENDOR_DEPENDENT                     0
...
#define BTPS_CONFIGURATION_GAVD_SUPPORT_MULTIPLEXING                          0
#define BTPS_CONFIGURATION_GAVD_SUPPORT_REPORTING_CHANNEL                     0
#define BTPS_CONFIGURATION_GAVD_SUPPORT_RECOVERY_CHANNEL                      0
#define BTPS_CONFIGURATION_GAVD_SUPPORT_SECURITY_CONTROL                      0
#define BTPS_CONFIGURATION_GAVD_SUPPORT_HEADER_COMPRESSION                    0
...
#define BTPS_CONFIGURATION_HDSET_SUPPORT_AUDIO_DATA                           0

   /* HFRE Configuration.                                               */
#define BTPS_CONFIGURATION_HFRE_SUPPORT_HANDSFREE_ROLE                        1
#define BTPS_CONFIGURATION_HFRE_SUPPORT_AUDIO_GATEWAY_ROLE                    0
#define BTPS_CONFIGURATION_HFRE_SUPPORT_AUDIO_DATA                            0
...
#define BTPS_CONFIGURATION_ISPP_SUPPORT_QUEUE_SESSION_PACKET_POINTER          1
   ...
   /* GATT Configuration.                                               */
#define BTPS_CONFIGURATION_GATT_MAXIMUM_SUPPORTED_MTU_SIZE                  ((50 > L2CAP_MAXIMUM_SUPPORTED_STACK_MTU)?L2CAP_MAXIMUM_SUPPORTED_STACK_MTU:50)
...
#define BTPS_CONFIGURATION_AUD_ENDPOINT_MEDIA_CHANNEL_MTU_SIZE              800
#define BTPS_CONFIGURATION_AUD_ENDPOINT_REPORTING_CHANNEL_MTU_SIZE          800
#define BTPS_CONFIGURATION_AUD_ENDPOINT_RECOVERY_CHANNEL_MTU_SIZE           800
...
#define BTPS_CONFIGURATION_AUD_REMOTE_CONTROL_CONNECT_TIMEOUT_ACCEPTOR_MS   2000
