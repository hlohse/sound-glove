...
typedef struct _tagQWord_t
{
   DWord_t UpperDWord;
   DWord_t LowerDWord;
} QWord_t;                                      /* Generic 64 bit Container.  */
...
typedef struct _tagSQWord_t
{
   SDWord_t UpperDWord;
   SDWord_t LowerDWord;
} SQWord_t;                                     /* Signed 64 bit Container.   */
...
{                                                                   \
  ((Byte_t *)(_x))[0] = ((Byte_t)(((DWord_t)((_y).LowerDWord)) & 0xFF));         \
  ((Byte_t *)(_x))[1] = ((Byte_t)((((DWord_t)((_y).LowerDWord)) >> 8) & 0xFF));  \
  ((Byte_t *)(_x))[2] = ((Byte_t)((((DWord_t)((_y).LowerDWord)) >> 16) & 0xFF)); \
  ((Byte_t *)(_x))[3] = ((Byte_t)((((DWord_t)((_y).LowerDWord)) >> 24) & 0xFF)); \
  ((Byte_t *)(_x))[4] = ((Byte_t)(((DWord_t)((_y).UpperDWord)) & 0xFF)); \
  ((Byte_t *)(_x))[5] = ((Byte_t)((((DWord_t)((_y).UpperDWord)) >> 8) & 0xFF)); \
  ((Byte_t *)(_x))[6] = ((Byte_t)((((DWord_t)((_y).UpperDWord)) >> 16) & 0xFF)); \
  ((Byte_t *)(_x))[7] = ((Byte_t)((((DWord_t)((_y).UpperDWord)) >> 24) & 0xFF)); \
}
...
#define READ_UNALIGNED_QWORD_LITTLE_ENDIAN(_x)  {(((DWord_t)(((Byte_t *)(_x))[7])) << 24) | (((DWord_t)(((Byte_t *)(_x))[6])) << 16) | (((DWord_t)(((Byte_t *)(_x))[5])) << 8) | (((DWord_t)(((Byte_t *)(_x))[4]))), (((DWord_t)(((Byte_t *)(_x))[2])) << 24) | (((DWord_t)(((Byte_t *)(_x))[2])) << 16) | (((DWord_t)(((Byte_t *)(_x))[1])) << 8) | (((DWord_t)(((Byte_t *)(_x))[0])))}

   /* The following is a utility MACRO that exists to Read an unaligned */
   /* Little Endian QWord_t from a specifed Memory Address into a       */
   /* specified memory address.  This MACRO accepts as it's first       */
   /* parameter the unaligned Memory Address of the Big Endian QWord_t  */
   /* to read.  This function returns a QWord_t (in the Endian-ness of  */
   /* the Native Host Processor).                                       */
#define READ_INTO_UNALIGNED_QWORD_LITTLE_ENDIAN(_dest, _source)      \
{                                                                    \
   ((QWord_t *)(_dest))->UpperDWord = READ_UNALIGNED_DWORD_LITTLE_ENDIAN(&(((NonAlignedQWord_t *)(_source))->NonAlignedQWord4)); \
   ((QWord_t *)(_dest))->LowerDWord = READ_UNALIGNED_DWORD_LITTLE_ENDIAN(&(((NonAlignedQWord_t *)(_source))->NonAlignedQWord0)); \
}
...
{                                                                   \
  ((Byte_t *)(_x))[7] = ((Byte_t)(((DWord_t)((_y).LowerDWord)) & 0xFF));         \
  ((Byte_t *)(_x))[6] = ((Byte_t)((((DWord_t)((_y).LowerDWord)) >> 8) & 0xFF));  \
  ((Byte_t *)(_x))[5] = ((Byte_t)((((DWord_t)((_y).LowerDWord)) >> 16) & 0xFF)); \
  ((Byte_t *)(_x))[4] = ((Byte_t)((((DWord_t)((_y).LowerDWord)) >> 24) & 0xFF)); \
  ((Byte_t *)(_x))[3] = ((Byte_t)(((DWord_t)((_y).UpperDWord)) & 0xFF)); \
  ((Byte_t *)(_x))[2] = ((Byte_t)((((DWord_t)((_y).UpperDWord)) >> 8) & 0xFF)); \
  ((Byte_t *)(_x))[1] = ((Byte_t)((((DWord_t)((_y).UpperDWord)) >> 16) & 0xFF)); \
  ((Byte_t *)(_x))[0] = ((Byte_t)((((DWord_t)((_y).UpperDWord)) >> 24) & 0xFF)); \
}
...
#define READ_UNALIGNED_DWORD_BIG_ENDIAN(_x)     ((DWord_t)((((DWord_t)(((Byte_t *)(_x))[0])) << 24) | (((DWord_t)(((Byte_t *)(_x))[1])) << 16) | (((DWord_t)(((Byte_t *)(_x))[2])) << 8) | ((DWord_t)(((Byte_t *)(_x))[3]))))
   ...
   /* (in the Endian-ness of the Native Host Processor).                */
#define READ_UNALIGNED_QWORD_BIG_ENDIAN(_x)     {(((DWord_t)(((Byte_t *)(_x))[0])) << 24) | (((DWord_t)(((Byte_t *)(_x))[1])) << 16) | (((DWord_t)(((Byte_t *)(_x))[2])) << 8) | (((DWord_t)(((Byte_t *)(_x))[3]))), (((DWord_t)(((Byte_t *)(_x))[4])) << 24) | (((DWord_t)(((Byte_t *)(_x))[5])) << 16) | (((DWord_t)(((Byte_t *)(_x))[6])) << 8) | (((DWord_t)(((Byte_t *)(_x))[7])))}

   /* The following is a utility MACRO that exists to Read an unaligned */
   /* Big Endian QWord_t from a specifed Memory Address into a specified*/
   /* memory address.  This MACRO accepts as it's first parameter the   */
   /* unaligned Memory Address of the Big Endian QWord_t to read.  This */
   /* function returns a QWord_t (in the Endian-ness of the Native Host */
   /* Processor).                                                       */
#define READ_INTO_UNALIGNED_QWORD_BIG_ENDIAN(_dest, _source)         \
{                                                                    \
   ((QWord_t *)(_dest))->UpperDWord = READ_UNALIGNED_DWORD_BIG_ENDIAN(&(((NonAlignedQWord_t *)(_source))->NonAlignedQWord0)); \
   ((QWord_t *)(_dest))->LowerDWord = READ_UNALIGNED_DWORD_BIG_ENDIAN(&(((NonAlignedQWord_t *)(_source))->NonAlignedQWord4)); \
}
